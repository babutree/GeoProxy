...
const proxyColumns = `id, address, protocol, exit_ip, exit_location, latency, quality_grade,
	...
	region, region_source, note, ipapiis_score, ipapi_flags, ipapi_flags_seen, starred, cf_blocked`
...
func scanProxy(rows proxyScanner) (*Proxy, error) {
	...
	var userPaused, ipapiFlagsSeen, starred int
